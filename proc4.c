...
static void hwaddr_v4_show_entry(struct hwaddr_v4_entry *entry, void *data)
{
...
static int hwaddr_v4_show_cache(struct seq_file *sf, void *unused)
{
	hwaddr_v4_foreach(hwaddr_v4_show_entry, sf);
...
{
	return single_open(file, hwaddr_v4_show_cache, NULL);
}
...
int hwaddr_v4_proc_create(void)
{
...
void hwaddr_v4_proc_destroy(void)
{
